...
--
-- Servidor: localhost
-- Tiempo de generación: 04-07-2024 a las 14:17:43
...
(4, 'docente', 'seleccionar crear modificar', 'docentes periodos horarios_docentes novedades'),
(5, 'apoyo', 'seleccionar crear modificar', 'docentes periodos materias aulas nrc gestor_horarios horarios_docentes novedades'),
(11, 'Supervisor', 'crear eliminar', 'perfiles');
...
(10, 'L00000001', 'admina', 'admin', 'admin', '$2y$10$b6DhvvQHzdQsvtlLBWQNbOZTQL3s06cmq8d4/C7N1Kvbt0Qp2.Jti', 3),
(11, 'L00000002', 'Stephen', 'Drouet', 'sddrouet', '$2y$10$hHpzFX2mfFEvzeuOA87n0eVdGr7CWWhQItg9LTNzrYzfzWz4u4X9y', 4),
(12, 'L00000003', 'Javier', 'Gonzaga', 'jjgonzaga', '$2y$10$b6DhvvQHzdQsvtlLBWQNbOZTQL3s06cmq8d4/C7N1Kvbt0Qp2.Jti', 4),
...
--
ALTER TABLE `horarios`
  MODIFY `id_horario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de la tabla `horarios_aulas`
--
ALTER TABLE `horarios_aulas`
  MODIFY `id_horario__aula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9478;

--
-- AUTO_INCREMENT de la tabla `horarios_aulas_cursos`
--
ALTER TABLE `horarios_aulas_cursos`
  MODIFY `id_horarios_aulas_cursos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
ALTER TABLE `periodos_docentes`
  MODIFY `id_periodo_docente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `periodos_horarios`
--
ALTER TABLE `periodos_horarios`
  MODIFY `id_periodo_horario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=265;
